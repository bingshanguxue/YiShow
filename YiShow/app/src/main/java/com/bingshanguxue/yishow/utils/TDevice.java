...
import com.bingshanguxue.yishow.app.helper.SharedPreferencesManager;
...
public class TDevice {
	...
	String udid = SharedPreferencesManager.getPreferences().getString("udid", "");
	if (udid.length() == 0) {
	    SharedPreferences.Editor editor = SharedPreferencesManager.getPreferences()
		    .edit();
