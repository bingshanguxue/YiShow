...
import com.bingshanguxue.yishow.zxing.camera.CameraManager;
import com.bingshanguxue.yishow.zxing.decode.DecodeThread;
import com.bingshanguxue.yishow.zxing.utils.BeepManager;
import com.bingshanguxue.yishow.zxing.utils.CaptureActivityHandler;
import com.bingshanguxue.yishow.zxing.utils.InactivityTimer;
    ...
    private void showUrlOption(final String url) {
        ...
        dialog.setNegativeButton("打开", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                UIHelper.openBrowser(CaptureActivity.this, url);
                dialog.dismiss();
                finish();
            }
        });
